...
import mu.KLogging
import nl.avisi.tech.lab.inventory.messaging.MessagingConfiguration.Companion.EXCHANGE_NAME
...
class MessageSender(
    ...
    fun sendMessage(message: RequestBrewingMessage, routingKey: String) {
